...
<header class="">
  ...
  <nav class="sidebar" style="background-color:pink;">
    <div class="navbar-collapse" id="navbar-collapse">
      ...
      <ul class="nav">
        ...
        <li><a href="./register.php" title="">Sign in</a></li>
        <li><a href="./contact.html" title="">About</a></li>
        <li><a href="./project.html" title="">Health Tips</a></li>
        <li><a href="./components.html" title="">Exercise</a></li>
...
<div class="hero-full-wrapper">
  ...
  <div class="gutter-sizer"></div>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./assets/images/a.jpg">
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./assets/images/d.jpg">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
    ...
    <div class="grid-item">
      <img class="img-responsive" alt="" src="./assets/images/p.jpg">
      <a href="./project.html" class="project-description">
        <div class="project-text-holder">
          <div class="project-text-inner">
            <h3>Vivamus vestibulum</h3>
